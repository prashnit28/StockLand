...
const DisplayStockList = ({ User,Data,TrigerEvent}) => {
    ...
    const CompanyList = Data.map((CompanyData,index)=>{
        return(
            <div>
                <ViewMyStock CName={CompanyData.stockName} BPrice={CompanyData.stockPrice} BDate={CompanyData.buyDate} User={User}  ind={index} FindData={FindData}/>
            </div>
        );
    });
        ...
        <div className="Stocks">
            ...
            <div id="AddStocksList">
                <div className="ListHeaders d-flex justify-content-around">
                    ...
                    <div className=' d-flex  justify-content-between'><u><h4 className='PageSubSubTitle'>Buy Date</h4></u></div>            
